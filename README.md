...
├── cve-risk-prioritisation-uk-sectors.pdf   # Full written report and stakeholder brief
└── README.md
```

## Report

The repository includes `cve-risk-prioritisation-uk-sectors.pdf`, which documents the full analysis behind the notebook.
